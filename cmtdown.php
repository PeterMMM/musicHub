...
$down = $GUP['cmt_down_co'];
$postId = $GUP['post_id'];	
	
//if  already up or not (checking)
$sqlGU = "SELECT * FROM cmt_down_file WHERE user_id ='$userId' AND cmt_id='$cmtId' ";
...
echo "FROM DT";
	...
	$sqlAU = "INSERT INTO cmt_down_file ( user_id, cmt_id) VALUES ( '$userId', '$cmtId' )";
...
$sqlUU = "UPDATE cmt_file SET cmt_down_co = $down +1  WHERE cmt_id= '$cmtId'";
